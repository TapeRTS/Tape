...
public abstract class OpenALMusic implements Music {
    ...
    public void stop() {
        if (!this.audio.noDevice && this.sourceID != -1) {
            ...
            this.renderedSecondsQueue.m373c();
    ...
    public void setPan(float f, float f2) {
        ...
        this.pan = f;
        if (!this.audio.noDevice && this.sourceID != -1) {
            AL10.alSource3f(this.sourceID, 4100, C1142m.m327b(((f - 1.0f) * 3.1415927f) / 2.0f), 0.0f, C1142m.m330a(((f + 1.0f) * 3.1415927f) / 2.0f));
    ...
    public void setPosition(float f) {
        if (!this.audio.noDevice && this.sourceID != -1) {
            ...
            while (this.renderedSecondsQueue.f7001b > 0) {
                this.renderedSeconds = this.renderedSecondsQueue.m379a();
            }
            ...
            this.renderedSecondsQueue.m378a(this.renderedSeconds);
            boolean z2 = false;
            for (int i = 0; i < 3; i++) {
                int i2 = this.buffers.get(i);
                if (!fill(i2)) {
            ...
            this.renderedSecondsQueue.m379a();
            if (!z2) {
                stop();
    ...
    private boolean fill(int i) {
        ...
        if (read <= 0) {
            if (this.isLooping) {
                ...
                if (this.renderedSecondsQueue.f7001b > 0) {
                    this.renderedSecondsQueue.m376a(0, 0.0f);
                }
            } else {
                return false;
            }
        }
        this.renderedSecondsQueue.m374b(0, (this.renderedSecondsQueue.f7001b > 0 ? this.renderedSecondsQueue.m375b() : 0.0f) + ((this.maxSecondsPerBuffer * read) / 40960.0f));
