...
public class SteamUserStats extends SteamInterface {
    ...
    public SteamAPICall uploadLeaderboardScore(SteamLeaderboardHandle steamLeaderboardHandle, LeaderboardUploadScoreMethod leaderboardUploadScoreMethod, int i, int[] iArr) {
        long j;
        if (iArr == null) {
            j = uploadLeaderboardScore(this.pointer, this.callback, steamLeaderboardHandle.handle, leaderboardUploadScoreMethod.ordinal(), i);
        } else {
            j = uploadLeaderboardScore(this.pointer, this.callback, steamLeaderboardHandle.handle, leaderboardUploadScoreMethod.ordinal(), i, iArr, iArr.length);
        }
        return new SteamAPICall(j);
    }
